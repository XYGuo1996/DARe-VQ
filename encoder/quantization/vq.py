...
class ResidualVectorQuantizer(nn.Module):
    ...
    def __init__(
        ...
        self.spectokenizer_bank_size = spectokenizer_bank_size
        ...
        self.vq = LanguageVectorQuantization(
            ...
            dead_code_strategy=self.dead_code_strategy,
            split_candidate_strategy=self.split_candidate_strategy,
            split_frequency_weight=self.split_frequency_weight,
            split_variance_weight=self.split_variance_weight,
            spectokenizer_bank_size=self.spectokenizer_bank_size,
        )
